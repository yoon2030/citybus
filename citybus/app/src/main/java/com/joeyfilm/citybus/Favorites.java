...
public class Favorites extends AppCompatActivity {
    ...
    private faListViewAdapter listViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView)findViewById(R.id.falist);
        listViewAdapter = new faListViewAdapter();
    ...
    public void addItem() {
        mReference.child("user").child("001").child("favorite").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                int a = 1; //
                String str = "favorite0"; // 바뀌는 숫자를 제외한 이름
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    listViewAdapter.addItem(start,stop);
                    a++;
                }
